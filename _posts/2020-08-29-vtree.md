...
{% include screenshot url="{{ site.baseurl }}/images/tbl_summary_example.png" caption="tbl_summary example output" %}
...
{% include screenshot url="{{ site.baseurl }}/images/vtree_example.png" caption="vtree example output" %}
